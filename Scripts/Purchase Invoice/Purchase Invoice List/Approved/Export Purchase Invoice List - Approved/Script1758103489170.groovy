...
WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/PIL_Approved/APPROVED-2/Page_FlowSys Purchase Invoices/button_PIL_Draft-tab'))
...
WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/PIL_Approved/Page_FlowSys Purchase Invoices/button_Export-Approved'))

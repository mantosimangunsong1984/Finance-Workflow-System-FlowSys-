...
WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/PIL_Draft/PI-HJ-023/Page_FlowSys Purchase Invoices/input_Checkbox_PI-HJ-023'))
...
WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/PIL_Draft/Submit For Approval/Page_FlowSys Purchase Invoices/button_Submit for Approvel'))

...
WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/Button Upload Files/Page_FlowSys Purchase Invoices/button_Draft Purchase Invoices_UPLOAD'), 
...
WebUI.uploadFile(findTestObject('Purchase Invoice/Purchase Invoice List/Button Upload Files/Page_FlowSys Purchase Invoices/input_Select Invoice File_Choose-File'), 
    'C:\\Users\\manto.manto\\Downloads\\Activity-SILAS.xlsx')

...
WebUI.setText(findTestObject('Setting/Document Type/Edit Document Type/Page_FlowSys Purchase Invoices Upload History/input_search_Document Type'), 
    'OTH88')

WebUI.click(findTestObject('Setting/Document Type/Edit Document Type/Page_FlowSys Purchase Invoices Upload History/Btn_Delete_DocumentType_OTH999'))

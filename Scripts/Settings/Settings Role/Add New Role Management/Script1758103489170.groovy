...
WebUI.click(findTestObject('Setting/Settings Role/Page_FlowSys/Btn_AddNewRole-Setting'))

WebUI.setText(findTestObject('Setting/Settings Role/View Detail User Mapping/Page_FlowSys/input_RoleName_AddNewRole'), 'TESTNEWROLE')

WebUI.click(findTestObject('Setting/Settings Role/View Detail User Mapping/Page_FlowSys/button_Save_AddNewRole'))

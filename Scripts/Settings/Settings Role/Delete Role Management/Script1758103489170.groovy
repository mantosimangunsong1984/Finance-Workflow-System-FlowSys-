...
WebUI.click(findTestObject('Setting/Settings Role/View Detail User Mapping/Page_FlowSys/a_Delete_TestUAT_SettingRole'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Setting/Settings Role/View Detail User Mapping/Page_FlowSys/button_NO_Confirm_AssignUser'), 
    FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Setting/Workflow Setup/Delete Workflow Setup/Page_FlowSys Workflow Setup/button_Delete_WorkflowSetup_Triple Same Approval - Copy'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Setting/Workflow Setup/Delete Workflow Setup/Page_FlowSys Workflow Setup/button_YES_Confirm'))

...
WebUI.click(findTestObject('Approvals/Approval History/a_Approval-History'))

WebUI.setText(findTestObject('Approvals/Approval History/input_search_Approval-History'), 'INV-CR-000906')

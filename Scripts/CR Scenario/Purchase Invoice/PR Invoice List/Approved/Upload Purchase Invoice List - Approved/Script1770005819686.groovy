...
WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/PIL_Approved/Page_FlowSys Purchase Invoices/button-UPLOAD-Approved'))
...
not_run: WebUI.click(findTestObject('Purchase Invoice/Purchase Invoice List/Button Upload Files/Page_FlowSys Purchase Invoices/button_Upload_PI'))
